...
public class Old_TopicViewlet 
{
	...
	public static void Login(String sDriver, String sDriverpath, String Dashboardname) throws Exception
	{
		 ...
		 * Thread.sleep(2000); dd.selectByIndex(Integer.parseInt(WGS_INDEX));
		 */
	...
	public static void AddTopicViewlet(String Topicname, ITestContext context) throws InterruptedException
	{
		 ...
		 * Select dd1=new
		 * Select(driver.findElement(By.cssSelector("select[name=\"wgsKey\"]")));
		 * Thread.sleep(2000); dd1.selectByVisibleText(WGSName);
		 */
		
		driver.findElement(By.xpath("//div/div/div[2]/div/div/div[2]/ng-select/div/span")).click();
		Thread.sleep(3000);   
		
		WebElement dropw1=driver.findElement(By.className("ng-dropdown-panel")).findElement(By.className("ng-dropdown-panel-items"));
		List<WebElement> divw1=dropw1.findElements(By.tagName("div")); 
		//System.out.println("Number of divs are: " +divw1.size());
		
		for(WebElement diw1 : divw1)
		{
			//System.out.println("WGS text is :" +diw1.getText());
			if(diw1.getText().equalsIgnoreCase(WGSName))
			{
				diw1.click();
				break;
			}	
	...
	public void CreateTopic(String Dashboardname, String TopicNameFromOptions, String Description, String TopicUniquestring, ITestContext context) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("(//input[@type='text'])[9]")).sendKeys(DestinationManager);
		Thread.sleep(4000);
	...
	public void CopyAsFromCommands(String Dashboardname, String CopyObjectName, String TopicNameFromOptions, String TopicUniquestringForCopyAs, ITestContext context) throws InterruptedException
	{
    	...
    	driver.findElement(By.xpath("(//input[@type='text'])[9]")).clear();
    	driver.findElement(By.xpath("(//input[@type='text'])[9]")).sendKeys(CopyasTopicName);
    	Thread.sleep(2000);
	...
	public static void CompareTopics(ITestContext context) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/div/app-tab/div/div/div[3]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/div/app-tab/div/div/div[3]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[2]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input")).click();
		Thread.sleep(LowSleep);
	...
	public void CopyAsFromCommandsForMultipleTopics(String Dashboardname, String TopicNameFromIcon, String DescriptionFromIcon, String TopicUniquestringFromICon, String CopyObjectNameForMultiple, String TopicUniquestringForMultipleCopy, ITestContext context) throws InterruptedException
	{
    	...
    	//Refresh the viewlet
    	driver.findElement(By.xpath("//div[3]/app-viewlet/div/div[2]/div/div/div/div[2]/div/div/i")).click();
    	Thread.sleep(4000);
    	...
    	//Search with that name
    	driver.findElement(By.xpath("(//input[@type='text'])[9]")).clear();
    	driver.findElement(By.xpath("(//input[@type='text'])[9]")).sendKeys(FinaleCopyAsName);
    	Thread.sleep(2000);
	...
	{	
		...
		driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/div/app-tab/div/div/div[3]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[2]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/div/app-tab/div/div/div[3]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[3]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input")).click();
		Thread.sleep(3000);
		driver.findElement(By.linkText("Add to favorites...")).click();
		Thread.sleep(3000);
