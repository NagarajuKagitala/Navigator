...
public class IIBServicesViewlet 
{
	...
	public static void AddIIBServiceViewlet(String ViewletName, int ViewletValue, ITestContext context) throws InterruptedException
	{
		...
		{
			System.out.println("IIB Services Viewlet is created");
			context.setAttribute("Status",1);
			context.setAttribute("Comment", "IIB Services viewlet is created successfully");
		}
		else
		{
			System.out.println("IIB Services viewlet is not created");
			context.setAttribute("Status",5);
			context.setAttribute("Comment", "Failed to create IIB Services viewlet");
	...
	@Test(priority=3)
	public static void ShowObjectAttributesForIIBService(String Dashboardname, String schemaName, ITestContext context) throws InterruptedException
	{
		try {
			IIBObjectAttributes obj=new IIBObjectAttributes();
		obj.IIBBrokerShowObjectAttributes(Dashboardname, driver, schemaName);
		context.setAttribute("Status",1);
		context.setAttribute("Comment", "Show object attributes for IIB Services viewlet is working fine");
		}
		catch(Exception e)
		{
			context.setAttribute("Status",5);
			context.setAttribute("Comment", "Failed to Show object attributes for IIB Services viewlet, check details: "+ e.getMessage());
	...
	@Test(priority=4)
	public static void CustomAttributes(String AttributeName, String Value, ITestContext context) throws InterruptedException
	{
		//click on clear all selected checkbox
		driver.findElement(By.xpath("//datatable-header-cell[2]/div/i")).click();
		Thread.sleep(5000);
		
		//click on check box and choose custom attributes option
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//div[2]/input")).sendKeys(Value);	
        ...
        driver.findElement(By.id("attrSearch")).sendKeys(Value);
	...
	{    	
		...
		String ApplicationName=driver.findElement(By.xpath("//datatable-body-cell[4]/div/span")).getText();
		System.out.println("object name is: "+ApplicationName);
