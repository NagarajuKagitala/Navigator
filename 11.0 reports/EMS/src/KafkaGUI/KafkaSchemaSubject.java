...
public class KafkaSchemaSubject 
{
		...
		public void ShowObjectAttributes(String Dashboardname, String SchemaName, ITestContext context) throws InterruptedException
		{
			try
			{
				...
				obj.SchemaSubjectShowObjectAttributes(Dashboardname, driver, SchemaName);
		...
		public void CreateKafkaSchemaSubject(String Dashboardname, String SubjectName, ITestContext context) throws InterruptedException
		{
			...
			String ResultSchemaname=driver.findElement(By.xpath("//div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper/datatable-body-row/div[2]/datatable-body-cell[7]/div/span")).getText();
		...
		public void Properties(String Dashboardname, ITestContext context) throws InterruptedException
		{
	    	...
	    	//get the page title
	    	String Namefield=driver.findElement(By.xpath("//app-modal-title/div/div/span")).getText();
	    	System.out.println("title is: " +Namefield);
	    		    				
			//Verification Condition
			if(Namefield.contains("Kafka Subject Schema Properties"))
			{
				System.out.println("The Schema subject name field is Disabled");
				context.setAttribute("Status",1);
	    		context.setAttribute("Comment", "Schema subject properties are working fine");
				driver.findElement(By.cssSelector(".btn-danger")).click();
			}
			else
			{
				System.out.println("The Schema subject name field is Enabled");
				context.setAttribute("Status",5);
	    		context.setAttribute("Comment", "Schema subject properties are not working properly");
				driver.findElement(By.cssSelector(".btn-danger")).click();
		...
		@Parameters({"Dashboardname", "SubjectName"})
		@TestRail(testCaseId = 1181)
		@Test(priority=3, dependsOnMethods = {"CreateKafkaSchemaSubject"})
		public void DeleteSchemaSubject(String Dashboardname, String SubjectName, ITestContext context) throws InterruptedException
		{
			//Clearing selection of object
			ClearSelectionofCheckbox che=new ClearSelectionofCheckbox();
			che.Deselectcheckbox(Dashboardname, driver);
			...
			{
				System.out.println("Schema subject is not deleted");
				context.setAttribute("Status", 5);
				context.setAttribute("Comment", "Failed to delete Schema subject");
				driver.findElement(By.xpath("Schema subject Delete failed")).click();
			}
			else
			{
				
				System.out.println("Schema subject is deleted Successfully");
				context.setAttribute("Status", 1);
				context.setAttribute("Comment", "Schema subject deleted Successfully");
			}
		}
