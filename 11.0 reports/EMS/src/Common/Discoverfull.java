...
public class Discoverfull 
{
	public void NodeDiscoverfull(String Dashboardname, String Node_Hostname, WebDriver driver) throws InterruptedException
	{
		WebElement cla=driver.findElement(By.className("tabs-panel-left-relative-block")).findElement(By.tagName("ul")); 
		  ...
		  //Discover full
		    driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/div/app-tab/div/div/div[2]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/div/input")).click();
		  ...
		  System.out.println("No of dashboards are1: " +lis1.size());
		  
		  for(WebElement li1: lis1) 
		  { 
			  //System.out.println("titles are: "+li.getAttribute("class")); 
			  WebElement fi1=li1.findElement(By.className("g-tab-title"));
		    // System.out.println("Dashboard Names are: " +fi1.getAttribute("textContent"));
